					                    	...
					                    	<div class="card-body">
							                	...
							                	@method('POST')
							                        <div class="form-group row">
							                          	...
							                          	<div class="col-sm-9">
							                            	<input type="text" name="nom" placeholder="Nom de véhicule" class="form-control form-control-success"><!--small class="form-text">Example help text that remains unchanged.</small-->
							                          	</div>
							                        </div>
							                        <div class="form-group row">
