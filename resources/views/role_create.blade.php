					                ...
					                <div style="margin-left: auto; margin-right: auto;" class="col-lg-12">
					                  	<div class="card">
						                    ...
						                    <div class="card-header d-flex align-items-center">
						                      	<h3 class="h4">Ajouter un role</h3>
						                    </div>
					                    	<div class="card-body">
							                	...
							                	@method('POST')
							                        <div class="form-group row">
							                          	...
							                          	<div class="col-sm-9">
							                            	<input type="text" name="name" class="form-control form-control-success"><!--small class="form-text">Example help text that remains unchanged.</small-->
							                          	</div>
							                        </div>
							                        <div class="form-group row">
							                          	...
							                          	<div class="col-sm-9">
							                          		@foreach($permission as $val)
							                            		...
							                            		<input type="checkbox" name="permission" id="permission" ><label for="{{ $val->name}}">{{ $val->name }}</label>&nbsp
